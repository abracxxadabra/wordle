...
def checkGuess(event, secret, input_fields, label, row):
    pass
    #TODO: Input code for wordle hinting rules here.
    #In addition to the functions defined below, you may find the following useful:
    #label.config(text="Your text goes here.") to set the text of the label
    #input_fields[row][col].config(disabledbackground='anycolour') to set the colour of an entry field in disabled state 
    #input_fields[row][col].config(bg='anycolour') to set the colour of an entry field in normal state 
